<%@ Page Title="t_user" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="hua_bbs.Web.User.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="face" HeaderText="face" SortExpression="face" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="regtime" HeaderText="regtime" SortExpression="regtime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="sex" HeaderText="sex" SortExpression="sex" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="truename" HeaderText="truename" SortExpression="truename" ItemStyle-HorizontalAlign="Center"  /> 
