...
namespace hua_bbs.DAL
{
	...
	public partial class UserDao
	{
		...
		public bool Exists(string nickname,int id)
		{
			...
			strSql.Append(" where nickname=@SQL2012nickname and id=@SQL2012id ");
			SqlParameter[] parameters = {
					new SqlParameter("@SQL2012nickname", SqlDbType.VarChar,20),
		...
		public int Add(hua_bbs.Model.User model)
		{
			...
			strSql.Append("@SQL2012email,@SQL2012face,@SQL2012mobile,@SQL2012nickname,@SQL2012password,@SQL2012regtime,@SQL2012sex,@SQL2012truename,@SQL2012type)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@SQL2012email", SqlDbType.VarChar,100),
					new SqlParameter("@SQL2012face", SqlDbType.VarChar,200),
					new SqlParameter("@SQL2012mobile", SqlDbType.VarChar,20),
					new SqlParameter("@SQL2012nickname", SqlDbType.VarChar,20),
					new SqlParameter("@SQL2012password", SqlDbType.VarChar,30),
					new SqlParameter("@SQL2012regtime", SqlDbType.DateTime),
					new SqlParameter("@SQL2012sex", SqlDbType.VarChar,4),
					new SqlParameter("@SQL2012truename", SqlDbType.VarChar,20),
					new SqlParameter("@SQL2012type", SqlDbType.VarChar,10)};
		...
		public bool Update(hua_bbs.Model.User model)
		{
			...
			strSql.Append("face=@SQL2012face,");
			...
			strSql.Append("truename=@SQL2012truename,");
		...
		/// 得到一个对象实体
		/// </summary>
		public hua_bbs.Model.User DataRowToModel(DataRow row)
		{
			hua_bbs.Model.User model=new hua_bbs.Model.User();
			if (row != null)
			{
